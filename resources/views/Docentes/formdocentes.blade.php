<div class=" row align-items-start" style="background-color:silver;">
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="input-group-text is-valid" name="nombre" value={{isset($docente->nombre)?$docente->nombre:''}} >
        <script>
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="input-group-text" name="apellido" value={{isset($docente->apellido)?$docente->apellido:''}} >
    </div>
